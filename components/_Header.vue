  ...
  <div>
    ...
    <div class="alert-error-box" v-if="showError">
      <div class="relative px-4 w-full h-full md:h-auto">
        <!-- Modal content -->
        <div
          class="relative bg-black rounded-lg shadow dark:bg-gray-700 w-full"
        >
          <!-- Modal header -->
          <div class="flex justify-end p-2">
            <button
              @click="handleLoginError('')"
              type="button"
              class="
                text-gray-400
                bg-transparent
          ...
          <div class="p-6 pt-0 text-center">
            <svg
              class="mx-auto mb-4 w-14 h-14 text-amber-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
              xmlns="http://www.w3.org/2000/svg"
      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              class="modal custom-modal-01 fade"
              id="exampleModal"
              tabindex="-1"
            ...
            >
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">Are you really want to sign out</div>
