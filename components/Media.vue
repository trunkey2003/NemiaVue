  ...
  <div id="meida" class="container w-full min-h-screen bg-gray-100 rounded-t-2xl">
    ...
    <div class="flex flex-wrap">
      ...
      >
        <div
          ...
          v-bind:style="{
            backgroundImage:
              'url(' + media.node.coverImage.large + ')',
          }"
          title="Woman holding a mug"
        ></div>
        <div
    ...
    <div class="flex flex-wrap w-full">
      ...
      >
        ...
        >
          <div class="max-h-full">
            <h2 v-if="!Media.characters.edges[index]" class="text-gray-900 font-bold text-lg">
              {{ (Media.characters.edges[index].node)? Media.characters.edges[index].node.name.full : "" }}
            </h2>
            <p class="text-center text-sm text-gray-600 my-2">
        ...
        >
          <div class="max-h-full">
            <h2 v-if="!Media.characters.edges[index].voiceActors" class="text-gray-900 font-bold text-lg">
              {{ (Media.characters.edges[index].voiceActors)? Media.characters.edges[index].voiceActors[0].name.full : "" }}
            </h2>
            <p class="text-center text-sm text-gray-600 my-2">
              {{ Media.characters.edges[index].voiceActors && Media.characters.edges[index].voiceActors[0].language }}
            </p>
          </div>
        </div>
        <div
          ...
          v-bind:style="{
            backgroundImage:
              'url(' +
              (Media.characters.edges[index].voiceActors && Media.characters.edges[index].voiceActors[0].image.large) +
              ')',
          }"
          title="Woman holding a mug"
        ></div>
