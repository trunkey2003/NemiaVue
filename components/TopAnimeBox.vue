<template>
  <div class="w-full flex mt-3">
    ...
    <div class="w-[95%] h-[110px] bg-white rounded flex p-[5px]">
      <div class="h-[100px] w-[80px] bg-gray-200">
        <img
          class="w-full h-full"
          v-bind:src="image"
        />
        ...
        <div class="w-[50%] font-bold">
          ...
          <div class="flex mt-2">
            <span
              ...
              v-bind:key="genre"
              class="mx-1 py-[2px] px-2 rounded-xl text-white text-sm"
	...
	c6.1-9.3,16-12.1,16-21.2C32,3.8,28.2,0,23.6,0z"
            ...
            <div class="ml-3">
              {{ averageScore }}%<br />{{ popularity }} users
            </div>
          </div>
          <div class="w-[30%] flex">
            <svg
            ...
            <div class="ml-3">
              {{ format }}<br />{{handleRenderTiming(episodes, duration)}}
            </div>
          </div>
          <div class="w-[30%] flex">
            <svg
            ...
            <div class="ml-3">{{handleCapitalizeString(season)}} {{year}}<br />{{status}}</div>
          </div>
        </div>
      </div>
    </div>
